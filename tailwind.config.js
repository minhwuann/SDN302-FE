...
/**
 * Ví Vi Vu design tokens.
 * Một bảng màu cool-neutral duy nhất + cobalt làm accent chung.
 * Được HeroUI consume qua semantic tokens (background, content1..4,
 * default, primary, success, warning, danger, divider, focus).
 */
...
export default {
  ...
  theme: {
    extend: {
      fontFamily: {
        // Một font family duy nhất cho toàn sản phẩm.
        // Giữ tên "heading" để không phải sửa các class font-heading cũ.
